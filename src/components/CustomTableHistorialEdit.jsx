...
const CustomTableHistorialEdit = ({ columns, data, totalAcumulado }) => {
        ...
        <div className="overflow-x-auto">
            <div className="p-2">
                ...
                <table className="table-auto w-full mx-auto text-center font-bold mt-2">
                    ...
                    <tfoot>
                        <tr>
                            <td colSpan={4} className="p-2 bg-customRed text-white px-6 text-start">
                                Total acumulado
                            </td>
                            <td colSpan={1} className="p-2 bg-customRed text-white px-6">
                                {totalAcumulado}
                            </td>
                            <td colSpan={2} className="p-2 bg-customRed text-white px-6">
...
export default CustomTableHistorialEdit;