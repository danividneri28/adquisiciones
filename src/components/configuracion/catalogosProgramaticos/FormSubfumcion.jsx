            ...
            <div className='block md:flex'>
                <div className='w-full md:w-1/2 px-2'>
                    ...
                    <select
                        ...
                        disabled={disabled}
                    >
                        <option value="1">Función 1</option>
                        <option value="2">Función 2</option>
                        <option value="3">Función 3</option>
                    </select>
                </div>
