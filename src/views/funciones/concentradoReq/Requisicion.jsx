    ...
    <>
      <div>
        ...
        <div className="bg-white  md:px-0 flex flex-col">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4  gap-4 md:gap-3 md:my-4">
            ...
            <div className="hidden lg:flex flex-col gap-4 mx-auto">
              <div className="flex gap-4">
                <p className="text-customRed font-bold text-sm">Requisición de Compra: </p>
                <button className="bg-customRed text-white px-4 rounded-lg lg:text-base">Descargar</button>
              </div>
              <div className="flex gap-4">
                <p className="text-customRed font-bold text-sm">Requisición de Compra: </p>
                <button className="bg-customRed text-white px-4 rounded-lg lg:text-base">Descargar</button>
          ...
          <div className="md:flex lg:hidden md:flex-row gap-32 p-2 my-4">
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
              <div className="">
                ...
                <select
                  name="descripcion"
                  className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-black focus:border-ring-black p-3 bg-white text-black"
                >
            ...
            <div className="flex justify-center">
                <button type="submit" className="bg-customRed text-white px-8 py-2 rounded-lg text-base font-bold cursor-pointer">Guardar</button>
              </div>   
          </form>
        </div>
      </div>
