    ...
    const columns = React.useMemo(
        () => [
            ...
            cell: (info) => (
                <div>
                    <Link
                    to={`/funciones/procedimientos/listado/show`}
        ...
        const data = React.useMemo(
            ...
            Array.from({ length: 1000 }, (_, i) => ({
                ...
                Estado: (
                <span
                    className="inline-flex items-center text-white rounded-lg bg-green-600 px-6 py-2 text-sm font-bold text-white ring-1 ring-inset"
                >
                    Autorizado
                </span>
                ),
            ...
            <>
                <div>
                    ...
                    items={[
                        ...
                        { href: "/funciones/procedimientos/listado", text: "REGISTROS DE PROCEDIMIENTOS ADMINISTRATIVOS" },
                        { text: "HISTORIAL DE PROCEDIMIENTOS ADMINISTRATIVOS" },
                    ]}
                    />
                    ...
                    />
                    <div className="mt-4 md:ml-40 md:mr-40 md:grid md:grid-rows-1 md:grid-flow-col md:gap-3">
                        <div className="md:grid md:grid-cols-6 md:gap-3 w-full sm:grid sm:grid-cols-1 sm:gap-0 bg-white rounded-lg size-auto text-center mt-2 md:h-24 border border-gray-400">
                            {/* Selectores */}
                            ...
                            <div className="md:block md:mr-3 mt-4 md:mt-0 mb-2 ml-2 mr-2 md:ml-0">
                                <button
                                    type="submit"
...
export default ProcedAdminHistorial