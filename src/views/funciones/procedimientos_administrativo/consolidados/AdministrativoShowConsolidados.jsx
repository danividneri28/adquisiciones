...
const AdministrativoShowConsolidados = () => {
    return (
        <>
            <div>
                <Breadcrumb
                ...
                />
                <Regresar enlace="/funciones/procedimientos/listado/consolidados/ver"/>
                <Titulo
                text={"REQUISICIÓN"}
                ...
                <div className="w-full rounded-lg mt-7" style={{ backgroundColor: "#956876" }}>
                    <div className="block rounded-lg text-sm md:text-base shadow-secondary-1 dark:bg-surface-dark dark:text-white">
                        ...
                        <div className="w-full bg-white">
                            <div className="grid grid-cols-1 md:grid md:grid-cols-4 md:gap-1 text-center">
...
export default AdministrativoShowConsolidados