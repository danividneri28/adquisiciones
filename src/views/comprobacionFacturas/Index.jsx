...
import historial from "../../assets/images/funciones/ComprobacionFacturas/historial.png";
import ApartadoConsolidados from "../../assets/images/funciones/ComprobacionFacturas/ApartadoConsolidados.png";

export default function ComprobacionFacturas() {
    ...
    return (
        <>
            <Breadcrumb
                items={[
                    ...
                    {
                        text: "REGISTROS DE FACTURACIONES Y FACTURAS",
                    },
                ]}
            />
            <a
        ...
        <Titulo text={"REGISTROS DE COMPROBACIONES Y FACTURAS"} />
            <div>
                <div className="flex justify-between items-center">
                    <Link to="/funciones/ComprobacionFacturas/historial" className="inline-block">
                        <img
                ...
                {/* APARTADO DE SELECT */}
                    <div className="mt-4 md:grid md:grid-rows-1 md:grid-flow-col md:gap-3">
                        <div className="grid grid-cols-1 md:grid-cols-6 gap-3 w-full bg-white rounded-lg text-center mt-2 md:h-24 border border-gray-400">
                            {/* Selectores */}
                            ...
                            <div className="mb-2 ml-2 mr-2 md:ml-0 md:mr-0">
                                <p className="text-customRed text-base md:text-lg my-2 font-bold text-center line-clamp-1">Área:</p>
                            ...
                            <div className="mb-2 ml-2 mr-2 md:ml-0 md:mr-0">
                                <p className="text-customRed text-base md:text-lg my-2 font-bold text-center line-clamp-1">Estado:</p>
                                <select className="py-1 md:py-3 lg:py-3 px-4 pe-9 block w-full border hover:border-gray-800 rounded-lg text-sm">
                                    <option hidden>Seleccionar</option>
                                    <option>Área</option>
                                    <option>Adquisiciones</option>
